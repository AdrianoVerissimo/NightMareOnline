...
namespace Photon.Pun.UtilityScripts
{
    ...
    {
        public GameControllerGamePlay gameControllerGamePlay;
        ...
        public void Update()
        {
            ...
            string seconds = (countdown % 60f).ToString("00");
            ...
            if (timeInText.Equals("0:00"))
            {
                ...
                gameControllerGamePlay.GetComponent<GameControllerGamePlay>().GameOver();
            }
